...
이번 실측에서 gpt-4o-mini는 더 낮은 공개 가격 기반 추정 비용과 더 낮게 관측된 avg/p95/p99 latency를 보였다. gpt-4o-mini의 `maxTokens(128)` 운영 옵션 계약도 실제 JSON 응답 변환으로 검증됐다. 상세 수치·한계는 [#66 Evidence](../evidence/v3/66-ai-moderation/README.md)를 기준으로 한다.
